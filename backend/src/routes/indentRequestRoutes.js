...
// // //       return res.status(400).json({ message: "Cannot edit after confirmation" });
// // //     }

// // //     // 🔥 MAP EXISTING ITEMS
// // //     const existingMap = new Map(
// // //       indent.items.map(i => [i.stockItemId.toString(), i])
// // //     );

// // //     const updatedItems = [];

// // //     for (let it of items) {
// // //       const id = it.stockItemId.toString();
// // //       const qty = Number(it.qtyBaseUnit || it.qty || 0);
...
// // //     indent.items = updatedItems.filter(i => i.qtyBaseUnit > 0);
...
// // // If indent was already completed,
// // // reopen it for receiving
// // if (
// //   indent.status === "received" ||
// //   indent.status === "partially_received"
// // ) {
// //   indent.status = "confirmed";
// // }
...
// // if (!indent) {
// //   return res.status(404).json({
// //     message: "Indent Request not found in database"
// //   });
// // }



// // const approvedItems = indent.items.filter(
// //   i => i.status === "approved"
// // );
// // let allReceived = true;
...
// //     error: "No approved items available for receiving"
// //   });
// // }
...
// // const finalReceiveQty = Number(receiveQty || 0);
...
// //   },
// //   {
// //     $inc: { qtyBaseUnit: finalReceiveQty }
// //   },
// //   { upsert: true, new: true }
// // );
// // }
...
// //     // Update status
// // const hasReceivedAnything = approvedItems.some(
// //   item => Number(item.receivedQty || 0) > 0
// // );

// // indent.status = hasReceivedAnything
// //   ? "received"
// //   : "confirmed";
...
//       ) {
//         return res.status(400).json({
//           error: "Cannot delete confirmed indent"
//         });
//       }
