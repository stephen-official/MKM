...
// // // // //     };
// // // // //   })
// // // // //   .filter(p => p.status === "approved" && p.receivedQty > 0);
// // // // //     if (payload.length === 0) return toast.error("Enter items to receive");
...
// // // // //       {it.qtyBaseUnit} {it.stockItemId?.unitId?.symbol || 'unit'}
// // // // //     </span>

// // // // //     {/* RECEIVED */}
// // // // //     <span className={`text-[10px] font-black ${
// // // // //       it.receivedQty > 0 ? 'text-green-600' : 'text-gray-300'
// // // // //     }`}>
// // // // //       {it.receivedQty || 0} {it.stockItemId?.unitId?.symbol || 'unit'}
// // // // //     </span>
...
// // // // //     {item.qtyBaseUnit || 0} {item.stockItemId?.unitId?.symbol || 'unit'}
// // // // //   </td>
...
// // // // //       min="0"
// // // // //       disabled={!isApproved}
// // // // //       placeholder={isApproved ? "0" : "Rejected"}
...
// // //     const validItems = cart.map(item => ({
// // //       stockItemId: item.stockItemId || item._id || item.stockRecordId,
// // //       qtyBaseUnit: limitTo3Decimals(item.requestedQty),
// // //       stockRecordId: item.stockRecordId
// // //     })).filter(it => Number(it.qtyBaseUnit) !== 0); // Only submit quantities > 0
...
// // //     return {
// // //       stockItemId,
// // //       receivedQty: limitTo3Decimals(qty),
// // //       status: item?.status
// // //     };
// // //   })
// // //   .filter(p => p.status === "approved" && p.receivedQty > 0);
...
// // //                             const current = parseFloat(item.requestedQty) || 0;
// // //                             // Only allow decrement if > 0
// // //                             if (current > 0) addToCart(item, limitTo3Decimals(current - 1));
// // //                         }} 
// // //                         className="w-7 h-7 rounded-lg bg-white border border-gray-200 flex items-center justify-center text-sm font-black"
// // //                       >
// // //                         -
...
// // //                         }}
// // //                       />
// // //                       <button onClick={() => addToCart(item, limitTo3Decimals((parseFloat(item.requestedQty) || 0) + 1))} className="w-7 h-7 rounded-lg bg-white border border-gray-200 flex items-center justify-center text-sm font-black">+</button>
// // //                     </div>
// // //                 </div>
// // //               ))}
// // //             </div>
...
//   onClick={() => {
//     setCart(prev =>
//       prev.filter(i => i.stockRecordId !== item.stockRecordId)
//     );
//   }}
        ...
        <div className="max-w-7xl mx-auto">
          {activeTransactionType !== 'usage' && (
              <div className={`mb-3 p-3 rounded-xl flex justify-between items-center ${activeTransactionType === 'indent' ? 'bg-orange-50 border border-orange-100' : 'bg-blue-50 border border-blue-100'}`}>
                ...
                <button onClick={() => { setActiveTransactionType('usage'); setCart([]); fetchItems(false);if (activeTransactionType === "indent") {
    setEditIndentId(null);
